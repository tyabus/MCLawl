...
namespace MCLawl
{
    public class Group
    {
        ...
        public static void InitAll()
        {
            ...
            if (GroupList.Find(grp => grp.Permission == LevelPermission.Admin) == null) GroupList.Add(new Group(LevelPermission.Admin, 65536, "SuperOP", 'e', "superops.txt"));
...
#pragma warning disable CS0642 // ¬озможно, ошибочный пустой оператор
                if (lines.Length == 0) ;
#pragma warning restore CS0642 // ¬озможно, ошибочный пустой оператор
