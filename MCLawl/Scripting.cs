    ...
    static class Scripting
    {
        ...
        public static void CreateNew(string CmdName)
        {
            ...
            sw.Write(
                ...
                Environment.NewLine +
                "\tUse this as a basis for custom commands implemented via the MCLawl scripting framework." + Environment.NewLine +
                ...
                "// As a note, MCLawl is designed for .NET 3.5." + Environment.NewLine +
        ...
        public static bool Compile(string commandName)
        {
            ...
            parameters.ReferencedAssemblies.Add("MCLawl.dll");
        ...
        /// </summary>
        /// <param name="name">String to convert to an MCLawl class name.</param>
